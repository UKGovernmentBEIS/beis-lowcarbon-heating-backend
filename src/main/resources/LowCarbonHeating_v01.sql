...
INSERT INTO application_form_section VALUES (1, 1, 1, 'Proposal Summary', '[{"name": "proposalsummary", "type": "simpleform", "isEnabled": true, "isNumeric": false, "simpleform": [{"name": "proposalsummary.name", "type": "text", "label": "Name of Applicant Business", "maxWords": 20, "fieldType": "text", "isEnabled": true, "isNumeric": false, "isMandatory": true}, {"name": "proposalsummary.title", "type": "text", "label": "Project Title", "maxWords": 20, "fieldType": "text", "isEnabled": true, "isNumeric": false, "isMandatory": true}, {"name": "proposalsummary.startdate", "type": "date", "label": "Estimated Start Date", "maxWords": 100, "fieldType": "date", "isEnabled": true, "isNumeric": true, "isMandatory": true}, {"name": "proposalsummary.duration", "type": "text", "label": "Project Duration (months)", "maxWords": 1, "fieldType": "text", "isEnabled": true, "isNumeric": true, "isMandatory": true}, {"name": "proposalsummary.costs", "type": "currency", "label": "Total Eligible Project Costs (£)", "maxWords": 10, "fieldType": "currency", "isEnabled": true, "isNumeric": true, "isMandatory": true}, {"name": "proposalsummary.totalcost", "type": "currency", "label": "Total BEIS grant applied for (£) (maximum award is £2 million) ", "maxWords": 10, "fieldType": "currency", "isEnabled": true, "isNumeric": true, "isMandatory": true}, {"name": "proposalsummary.pvtsectorcontrib", "type": "currency", "label": "Total private sector contribution to Project Costs (£)", "maxWords": 10, "fieldType": "currency", "isEnabled": true, "isNumeric": true, "isMandatory": true}, {"name": "proposalsummary.collaborativeapplication", "type": "dropdown", "label": "Is this a collaborative application?", "maxWords": 10, "fieldType": "dropdown", "isEnabled": true, "isNumeric": false, "isMandatory": true, "defaultvalue": "Yes:Yes,No:No"}]}]', 'simpleform');
...
INSERT INTO application_form_section VALUES (21, 1, 21, 'Assessment Criteria - Project Delivery: Milestones', '[{"name": "thermalefficiency", "type": "dynamictableform", "isEnabled": true, "isNumeric": false, "dynamictableform": [{"name": "thermalefficiency.row1", "fields": [{"name": "thermalefficiency.row1col1", "label": "Milestone number", "fieldType": "text", "isEnabled": true, "isNumeric": true}, {"name": "thermalefficiency.row1col2", "label": "Milestone name", "fieldType": "text", "isEnabled": true, "isNumeric": false}, {"name": "thermalefficiency.row1col3", "label": "Project partner lead for milestone delivery", "fieldType": "text", "isEnabled": true}, {"name": "thermalefficiency.row1col4", "label": "Brief description of milestone, including deliverables", "fieldType": "textarea", "isEnabled": true}], "isEnabled": true}]}]', 'dynamictableform');
